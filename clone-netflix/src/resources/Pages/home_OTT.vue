<template>
    <div style="background-color: black; height: 100vh;">
        <div :style="`background-image: url( ${'https://occ-0-1567-1123.1.nflxso.net/dnm/api/v5/rendition/412e4119fb212e3ca9f1add558e2e7fed42f8fb4/AAAABRvngexxF8H1-OzRWFSj6ddD-aB93tTBP9kMNz3cIVfuIfLEP1E_0saiNAwOtrM6xSOXvoiSCMsihWSkW0dq808-R7_lBnr6WHbjkKBX6I3sD0uCcS8kSPbRjEDdG8CeeVXEAEV6spQ.webp'} ); background-repeat: round; background-repeat: no-repeat; background-size: cover; height: 100%; ` + 'display: flex; align-items: flex-start;'">  
        <!-- <div :style="`background-image: url( ${user.avatar} ); background-repeat: round; padding: 10px; margin: 10px; ` + 'display: flex; align-items: end;'">   -->
            <navBar_Ott/>
...
export default{
    ...
    components:{
          navBar_Ott: () => import("../Nav_bar/_components/navBar_Ott.vue"),        
      }
}
</script>
<style scoped>
